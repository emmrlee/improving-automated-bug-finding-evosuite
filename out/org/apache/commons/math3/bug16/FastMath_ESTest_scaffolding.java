...
public class FastMath_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    shaded.org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.math3.util.FastMath"; 
  ...
  private static void initializeClasses() {
    shaded.org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FastMath_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    shaded.org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FastMath_ESTest_scaffolding.class.getClassLoader()); 
